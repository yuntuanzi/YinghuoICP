            ...
            if ($count > 0) {
                ...
                if (empty($errorMessage)) {
                    ...
                    if (empty($errors)) {
                        ...
                        header("Location: guide.php?keyword=" . urlencode($icpNumber));
                        exit;
                    } else {
            ...
            <form id="icp-form" method="post">
                ...
                <div class="agreement-container">
                    ...
                    <label for="agree-checkbox" class="agree-label">
                        我已经认真阅读并且承诺遵守
                        <a href="note.php" target="_blank" class="agreement-link">《对接须知》</a>
                    </label>
                </div>
                ...
                <div class="form-notice">
                    <?php if (isset($count) && $count > 0): ?>
                        <p class="notice-error">该备案号已被注册，请<a href="choose.php">重新选号</a></p>
                    <?php endif; ?>
